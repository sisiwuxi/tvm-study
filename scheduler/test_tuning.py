...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("resnet_18", [1, 3, 224, 224], "nvidia/geforce-gtx-960", "NHWC"),
    ],
)
...
if __name__ == """__main__""":
    # test_meta_schedule_tune_relay("resnet_18", [1, 3, 224, 224], "llvm --num-cores=4", "NHWC")
    test_meta_schedule_tune_relay("resnet_18", [1, 3, 224, 224], "nvidia/geforce-gtx-960", None)
