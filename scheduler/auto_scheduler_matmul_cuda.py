...
# 1024x1024. We then create a search task with M=N=K=1024 and dtype="float32"
#
...
M = N = K = 64
task = tvm.auto_scheduler.SearchTask(func=matmul_add, args=(M, K, N, "float32"), target=target)
