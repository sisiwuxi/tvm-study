...
extern "C"
#endif
TVM_DLL int32_t fused_nn_dense_nn_bias_add_nn_relu(void* args, void* arg_type_ids, int32_t num_args, void* out_ret_value, void* out_ret_tcode, void* resource_handle) {
  ...
  for (int32_t ax1_outer_ax0_outer_fused = 0; ax1_outer_ax0_outer_fused < 4; ++ax1_outer_ax0_outer_fused) {
    ...
    for (int32_t y_inner_outer_x_inner_outer_fused = 0; y_inner_outer_x_inner_outer_fused < 2; ++y_inner_outer_x_inner_outer_fused) {
      ...
      for (int32_t k_outer = 0; k_outer < 784; ++k_outer) {
        ((float16*)((float*)compute_global + (0)))[0] = (((float16*)((float*)compute_global + (0)))[0] + (((float16)(((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)])) * ((float16*)((float*)packed_weight + ((((ax1_outer_ax0_outer_fused * 25088) + (y_inner_outer_x_inner_outer_fused * 12544)) + (k_outer * 16)))))[0]));
      }
