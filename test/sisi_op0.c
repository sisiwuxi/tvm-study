...
extern "C"
#endif
TVM_DLL int32_t fused_nn_bias_add(void* args, void* arg_type_ids, int32_t num_args, void* out_ret_value, void* out_ret_tcode, void* resource_handle) {
  ...
  for (int32_t ax1_outer = 0; ax1_outer < 8; ++ax1_outer) {
    ((float16*)((float*)T_add + ((ax1_outer * 16))))[0] = (((float16*)((float*)placeholder + ((ax1_outer * 16))))[0] + ((float16*)((float*)placeholder1 + ((ax1_outer * 16))))[0]);
  }
  return 0;
}
...
extern "C"
#endif
TVM_DLL int32_t fused_nn_relu(void* args, void* arg_type_ids, int32_t num_args, void* out_ret_value, void* out_ret_tcode, void* resource_handle) {
  void* arg0 = (((TVMValue*)args)[0].v_handle);
  int32_t arg0_code = ((int32_t*)arg_type_ids)[(0)];
  void* arg1 = (((TVMValue*)args)[1].v_handle);
  int32_t arg1_code = ((int32_t*)arg_type_ids)[(1)];
  ...
  for (int32_t ax1_outer = 0; ax1_outer < 8; ++ax1_outer) {
    float16 _1 = ((float16*)((float*)placeholder + ((ax1_outer * 16))))[0];
    ...
    ((float16*)((float*)T_relu + ((ax1_outer * 16))))[0] = ((_1) > (_2) ? (_1) : (_2));
  }
  return 0;
}
...
extern "C"
#endif
TVM_DLL int32_t fused_nn_dense(void* args, void* arg_type_ids, int32_t num_args, void* out_ret_value, void* out_ret_tcode, void* resource_handle) {
  void* arg0 = (((TVMValue*)args)[0].v_handle);
  int32_t arg0_code = ((int32_t*)arg_type_ids)[(0)];
  void* arg1 = (((TVMValue*)args)[1].v_handle);
  int32_t arg1_code = ((int32_t*)arg_type_ids)[(1)];
  ...
  void* packed_weight = TVMBackendAllocWorkspace(1, dev_id, (uint64_t)401408, 2, 32);
  if (packed_weight == NULL) {
    return -1;
  }
  for (int32_t z = 0; z < 8; ++z) {
    for (int32_t y = 0; y < 784; ++y) {
      for (int32_t x = 0; x < 16; ++x) {
        ((float*)packed_weight)[((((z * 12544) + (y * 16)) + x))] = ((float*)placeholder1)[((((z * 12544) + (x * 784)) + y))];
      }
    }
  }
  for (int32_t x_outer_y_outer_fused = 0; x_outer_y_outer_fused < 4; ++x_outer_y_outer_fused) {
    ...
    for (int32_t y_inner_outer_x_inner_outer_fused = 0; y_inner_outer_x_inner_outer_fused < 2; ++y_inner_outer_x_inner_outer_fused) {
      ...
      for (int32_t k_outer = 0; k_outer < 784; ++k_outer) {
        ((float16*)((float*)compute_global + (0)))[0] = (((float16*)((float*)compute_global + (0)))[0] + (((float16)(((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)], ((float*)placeholder)[(k_outer)])) * ((float16*)((float*)packed_weight + ((((x_outer_y_outer_fused * 25088) + (y_inner_outer_x_inner_outer_fused * 12544)) + (k_outer * 16)))))[0]));
      }
      ((float16*)((float*)compute + (((x_outer_y_outer_fused * 32) + (y_inner_outer_x_inner_outer_fused * 16)))))[0] = ((float16*)((float*)compute_global + (0)))[0];
    }
