...
print("Opt1 Blocking: %f" % evaluator(a, b, c).mean)
...
evaluator = func.time_evaluator(func.entry_name, dev, number=10)
print("Opt2 Vectorization: %f" % evaluator(a, b, c).mean)
...
evaluator = func.time_evaluator(func.entry_name, dev, number=10)
print("Opt3 Loop Permutation: %f" % evaluator(a, b, c).mean)
...
evaluator = func.time_evaluator(func.entry_name, dev, number=10)
print("Opt4 Array Packing: %f" % evaluator(a, b, c).mean)
...
evaluator = func.time_evaluator(func.entry_name, dev, number=10)
print("Opt5 Write cache for blocks: %f" % evaluator(a, b, c).mean)
...
print("Opt6 Parallel: %f" % opt6_time)
